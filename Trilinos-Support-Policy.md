...
1. _**Related policies:**_ In order to improve future support capabilities and reduce support costs, Trilinos developers are expected to follow Trilinos policies for [Issue Management](Managing-Trilinos-Project-Issues), [Testing](Trilinos-Testing-Policy) and [Pre-push Testing](Policies-%7C-Safe-Checkin-Testing).
